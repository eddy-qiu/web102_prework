...
function addGamesToPage(games) {
    ...
    games.forEach( (game) => {
        ...
        const gameCard = document.createElement("card");
...
contributionsCard.innerHTML = `
    <p class="card-text">${totalContributions.toLocaleString()}</p>
`
...
raisedCard.innerHTML = `
    <p class="card-text">$${totalRaised.toLocaleString()}</p>
`
...
gamesCard.innerHTML = `
    <p class="card-text">${GAMES_JSON.length}</p>
`
...
let unfundedStr = `A total of $${totalRaised.toLocaleString()} has been raised for ${GAMES_JSON.length} games. 
